---
name: memory-systems
description: This skill should be used when the user asks to "implement agent memory",
...
license: MIT
compatibility: Requires Python 3.8+ for scripts. Graph database optional (Neo4j, etc.).
  Vector store optional (Pinecone, Weaviate, etc.).
metadata:
  version: 1.0.0
