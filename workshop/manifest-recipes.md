...
id: recipe-manifest
modified: '2026-05-26T17:52:09.942000'
status: log
type:
- log
---
...
## Active Recipes
- **agent/Claudeck/CLAUDE**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Claudeck/CLAUDE.md`
  - Target: `zk@adeck:~/.claude/CLAUDE.md`
  - Status: ✓ synced

- **agent/Claudi/Claudi**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Claudi/Claudi.md`
  - Target: `~/.claude/CLAUDE.md`
  - Target: `zk@zrrh:~/.claude/CLAUDE.md`
  - Status: ✓ synced

- **agent/Codeck/AGENTS**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Codeck/AGENTS.md`
  - Target: `zk@adeck:~/.codex/AGENTS.md`
  - Status: ✓ synced

- **agent/Codex/Codex**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Codex/Codex.md`
  - Target: `~/.codex/AGENTS.md`
  - Target: `zk@zrrh:~/.codex/AGENTS.md`
  - Status: ✓ synced

- **agent/Deckini/GEMINI**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Deckini/GEMINI.md`
  - Target: `zk@adeck:~/.gemini/GEMINI.md`
  - Status: ✓ synced

- **agent/Gemini/Gemini**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Gemini/Gemini.md`
  - Target: `~/.gemini/GEMINI.md`
  - Target: `zk@zrrh:~/.gemini/GEMINI.md`
  - Status: ✓ synced

- **agent/Kiro/agent**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Kiro/agent.md`
  - Target: `~/.kiro/steering/agent.md`
  - Status: ✓ synced

- **agent/Kiro/operator**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Kiro/operator.md`
  - Target: `~/.kiro/steering/operator.md`
  - Status: ✓ synced

- **agent/Kiro/mesh**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Kiro/mesh.md`
  - Target: `~/.kiro/steering/mesh.md`
  - Status: ✓ synced

- **agent/Kiro/principles**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Kiro/principles.md`
  - Target: `~/.kiro/steering/principles.md`
  - Status: ✓ synced

- **command/doc-consistency-check/doc-consistency-check**: Last run 2026-05-26T17:51:25.798810
...
- **command/doc-consistency-check/doc-consistency-check.kiro**: Last run 2026-05-26T17:51:25.798810
  - Output: `command/doc-consistency-check/doc-consistency-check.kiro.hook`
  - Target: `~/.kiro/hooks/doc-consistency-check.kiro.hook`
  - Status: ✓ synced

- **command/murder/murder**: Last run 2026-05-26T17:51:25.798810
...
- **command/murder/murder.kiro**: Last run 2026-05-26T17:51:25.798810
  - Output: `command/murder/murder.kiro.hook`
  - Target: `~/.kiro/hooks/murder.kiro.hook`
  - Status: ✓ synced

- **agent/deck (project steering)/AGENTS**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/deck (project steering)/AGENTS.md`
  - Target: `zk@adeck:~/AGENTS.md`
  - Status: ✓ synced

- **project/zk-context-vault/AGENTS**: Last run 2026-05-26T17:51:25.798810
  - Output: `project/zk-context-vault/AGENTS.md`
  - Target: `/mnt/repository/context-vault/AGENTS.md`
  - Status: ✓ synced

- **command/cave/cave**: Last run 2026-05-26T17:51:25.798810
...
- **command/cave/cave.kiro**: Last run 2026-05-26T17:51:25.798810
  - Output: `command/cave/cave.kiro.hook`
  - Target: `~/.kiro/hooks/cave.kiro.hook`
  - Status: ✓ synced

- **command/bedtime/bedtime**: Last run 2026-05-26T17:51:25.798810
...
- **command/bedtime/bedtime.kiro**: Last run 2026-05-26T17:51:25.798810
  - Output: `command/bedtime/bedtime.kiro.hook`
  - Target: `~/.kiro/hooks/bedtime.kiro.hook`
  - Status: ✓ synced

- **command/gamut/gamut**: Last run 2026-05-26T17:51:25.798810
...
- **command/gamut/gamut.kiro**: Last run 2026-05-26T17:51:25.798810
  - Output: `command/gamut/gamut.kiro.hook`
  - Target: `~/.kiro/hooks/gamut.kiro.hook`
  - Status: ✓ synced

- **command/moeverse/moeverse**: Last run 2026-05-26T17:51:25.798810
...
- **command/moeverse/moeverse.kiro**: Last run 2026-05-26T17:51:25.798810
  - Output: `command/moeverse/moeverse.kiro.hook`
  - Target: `~/.kiro/hooks/moeverse.kiro.hook`
  - Status: ✓ synced

- **command/reflect/reflect**: Last run 2026-05-26T17:51:25.798810
...
- **skill/mcp-builder**: Last run 2026-05-26T17:51:25.798810
...
- **skill/sideriod**: Last run 2026-05-26T17:51:25.798810
...
- **skill/catppuccin-theming**: Last run 2026-05-26T17:51:25.798810
...
- **skill/memory-systems**: Last run 2026-05-26T17:51:25.798810
...
- **skill/nix-os**: Last run 2026-05-26T17:51:25.798810
  - Output: `skill/nix-os/`
...
- **skill/openrgb**: Last run 2026-05-26T17:51:25.798810
...
- **agent/Grok/Grok**: Last run 2026-05-26T17:51:25.798810
  - Output: `agent/Grok/Grok.md`
  - Target: `~/.grok/agents/grok-vault.md`
  - Target: `zk@adeck:~/.grok/agents/grok-vault.md`
  - Status: ✓ synced
