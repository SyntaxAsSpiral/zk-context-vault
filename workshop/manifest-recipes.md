...
id: recipe-manifest
modified: '2026-03-31T17:19:04.350146'
status: log
type:
- log
---
...
## Active Recipes
- **agent/Claudeck/CLAUDE**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Claudeck/CLAUDE.md`
  - Target: `zk@adeck:~/.claude/CLAUDE.md`
  - Status: ✓ synced

- **agent/Claudi/Claudi**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Claudi/Claudi.md`
  - Target: `~/.claude/CLAUDE.md`
  - Target: `zk@zrrh:~/.claude/CLAUDE.md`
  - Status: ✓ synced

- **agent/Codeck/AGENTS**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Codeck/AGENTS.md`
  - Target: `zk@adeck:~/.codex/AGENTS.md`
  - Status: ✓ synced

- **agent/Codex/Codex**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Codex/Codex.md`
  - Target: `~/.codex/AGENTS.md`
  - Target: `zk@zrrh:~/.codex/AGENTS.md`
  - Status: ✓ synced

- **agent/Deckini/GEMINI**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Deckini/GEMINI.md`
  - Target: `zk@adeck:~/.gemini/GEMINI.md`
  - Status: ✓ synced

- **agent/Gemini/Gemini**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Gemini/Gemini.md`
  - Target: `~/.gemini/GEMINI.md`
  - Target: `zk@zrrh:~/.gemini/GEMINI.md`
  - Status: ✓ synced

- **agent/Kiro/agent**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Kiro/agent.md`
  - Target: `~/.kiro/steering/agent.md`
  - Status: ✓ synced

- **agent/Kiro/operator**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Kiro/operator.md`
  - Target: `~/.kiro/steering/operator.md`
  - Status: ✓ synced

- **agent/Kiro/mesh**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Kiro/mesh.md`
  - Target: `~/.kiro/steering/mesh.md`
  - Status: ✓ synced

- **agent/Kiro/principles**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/Kiro/principles.md`
  - Target: `~/.kiro/steering/principles.md`
  - Status: ✓ synced

- **command/doc-consistency-check/doc-consistency-check**: Last run 2026-03-31T17:17:42.381038
...
- **command/doc-consistency-check/doc-consistency-check.kiro**: Last run 2026-03-31T17:17:42.381038
  - Output: `command/doc-consistency-check/doc-consistency-check.kiro.hook`
  - Target: `~/.kiro/hooks/doc-consistency-check.kiro.hook`
  - Status: ✓ synced

- **command/murder/murder**: Last run 2026-03-31T17:17:42.381038
...
- **command/murder/murder.kiro**: Last run 2026-03-31T17:17:42.381038
  - Output: `command/murder/murder.kiro.hook`
  - Target: `~/.kiro/hooks/murder.kiro.hook`
  - Status: ✓ synced

- **power/catppuccin-theming**: Last run 2026-03-31T17:17:42.381038
  - Output: `power/catppuccin-theming/`
  - Target: `~/.kiro/powers/installed/catppuccin-theming/`
  - Status: ✓ synced

- **power/mcp-builder**: Last run 2026-03-31T17:17:42.381038
  - Output: `power/mcp-builder/`
  - Target: `~/.kiro/powers/installed/mcp-builder/`
  - Status: ✓ synced

- **power/memory-systems**: Last run 2026-03-31T17:17:42.381038
  - Output: `power/memory-systems/`
  - Target: `~/.kiro/powers/installed/memory-systems/`
  - Status: ✓ synced

- **power/nix-os**: Last run 2026-03-31T17:17:42.381038
  - Output: `power/nix-os/`
  - Target: `~/.kiro/powers/installed/nix-os/`
  - Status: ✓ synced

- **agent/deck (project steering)/AGENTS**: Last run 2026-03-31T17:17:42.381038
  - Output: `agent/deck (project steering)/AGENTS.md`
  - Target: `zk@adeck:~/AGENTS.md`
  - Status: ✓ synced

- **project/zk-context-vault/AGENTS**: Last run 2026-03-31T17:17:42.381038
  - Output: `project/zk-context-vault/AGENTS.md`
  - Target: `/mnt/repository/context-vault/AGENTS.md`
  - Status: ✓ synced

- **skill/catppuccin-theming**: Last run 2026-03-31T17:17:42.381038
...
- **skill/mcp-builder**: Last run 2026-03-31T17:17:42.381038
...
- **skill/memory-systems**: Last run 2026-03-31T17:17:42.381038
...
- **skill/nix-os**: Last run 2026-03-31T17:17:42.381038
  - Output: `skill/nix-os/`
