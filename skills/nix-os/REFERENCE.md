...
- **Tony Finn's Blog**: https://tonyfinn.com/blog/nix-from-first-principles-flake-edition/
...
- **Khanelinix**: https://github.com/khaneliman/khanelinix
    - System-Level Context Engine and Transformation Logic.
    - Source of truth for agent configuration, transforming descriptors into format-specific configs (Claude, Gemini, OpenCode).
