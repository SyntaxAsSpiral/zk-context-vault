...
Covenant Patterns operationalizes the [Pragma Covenant](../../principles.md) as enforceable design constraints. Unlike generic "best practices," these principles emerged from specific failures—each yama guards against a presumption that caused real damage.
