...
|-------|------|----------|-----------|
| ⚡ **Harmonion** | Hermeneutic Revelator | Semantic/phenomenological lens | Evaluation |
| 🍄 **Morphognome** | Grammatical Executor | Graph write authority | Synthesis |
| 🏺 **Critikon** | Taxeic Sker | Structural/boundary lens | Evaluation |
| 📕 **Archeoform** | Arterial Mnemonic | Canonical projection (bright field) | Emission |
| 🌀 **Antimorphogen** | Anamnetic Noös | Antimorphic stress test (dark field) | Negation |

### Structural Frame (Non-AI)

- **Dual Substrate**: Graph (semantic cards/links) + Git (mechanical versioning)
- **Domain Hierarchy**: Self (high friction) → Knowledge (medium friction) → Memory (immutable)
- **Processing Patterns**: Triquetra evaluation, dual-path mutation, gnomon projection, antibody development

### Application Domains

Specialized contexts extending the core: Pentasophos (gestalt), Xenotax (taxonomy), Gigi (trading), LudOS (narrative), Lexigōn (lexemancy)
...
1. **Triquetra Evaluation**: H+C parallel → M synthesis → graph write
2. **Dual-Path Mutation**: Content artifacts → graph | System artifacts → code
3. **Gnomon Projection**: Periodic canonical/antimorphic emissions
4. **Antibody Development**: Soft refusal → hard refusal → pattern immunity
...
*The architecture explains itself through its structure. No further documentation required.*
